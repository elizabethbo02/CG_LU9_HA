...
void render()
{
	...
	//a normal matrix to transform the normals for the vertices in world space
	//the transpose(inverse) calculation is to remove non-uniform scaling
	...
	gCubeShader.setFloat("material.shininess", 0.2f * 128);
